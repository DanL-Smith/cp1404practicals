...
# a list comprehension to create a list of all of the full_names in lowercase format
lowercase_full_names = [full_name.lower() for full_name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# a list comprehension to create a list of integers from the above list of strings
...
modified_numbers = [number for number in numbers if number > 9]
